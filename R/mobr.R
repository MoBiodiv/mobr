...
# "effort") New input: permute - if permute is FALSE, S_samp_rare is generated
# on the input comm_group if permute is TRUE, S_swap_rare is generated by Dan's
# new function avg_swap_rare() Output: a two-column data frame, with sample size
        ...
        names(out$continuous$N) = c('effort_ind', 'r_emp', 'r_null_low', 'r_null_median', 'r_null_high')
          ...
          for (group in group_levels) {
              ...
              for (i in 1:nperm){
                  ...
                  null_N_deltaS_mat[i, ] = N_eff_perm[ , 1] - N_eff_perm[ , 2]
              }
