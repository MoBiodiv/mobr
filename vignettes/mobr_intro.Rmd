...
par(mfrow=c(1,2))
plot_rarefaction(inv_mob_in, 'group', 'IBR', pooled=F, lwd=2,
                 leg_loc='topright')
plot_rarefaction(inv_mob_in, 'group', 'IBR', pooled=T, lwd=4,
                 leg_loc=NA)
```
...
inv_deltaS = get_delta_stats(inv_mob_in, 'group', ref_level='uninvaded',
                             type='discrete', log_scale=TRUE, n_perm = 99)
```
